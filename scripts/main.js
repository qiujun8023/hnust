...
(function() {
  ...
  userController = function($scope, $rootScope, $location, request) {
    ...
    return $('.ui.form').form({
      ...
      onSuccess: function() {
        ...
        $scope.error = '';
        $scope.loading = true;
        request.query(params, 8000, function(error, info, data) {
          $scope.loading = false;
          $scope.error = error;
          if (!error) {
  ...
  loginController = function($scope, $rootScope, $location, request) {
    ...
    return $('.ui.form').form({
      ...
      onSuccess: function() {
        ...
        $scope.error = '';
        $scope.loading = true;
        return request.query(params, 8000, function(error, info, data) {
          $scope.loading = false;
          $scope.error = error;
          if (!error) {
            return $scope.$emit('updateUserInfo');
  ...
  bookController = function($scope, $location, $timeout, request) {
    ...
    request.query({}, 8000, function(error, info, data) {
    ...
    $scope.renew = function(params) {
      params.method = 'renew';
      return request.query(params, 8000, function(data) {
        return $scope.data = data.data;
      });
    };
  ...
  editUserController = function($scope, $rootScope, $location, request) {
    $scope.studentId = '';
  ...
  lastUserController = function($scope, request) {
    $scope.error = '';
    $scope.loading = true;
    return request.query({}, 5000, function(error, info, data) {
      $scope.loading = false;
      $scope.error = error;
      return $scope.data = data;
    });
