...
(function() {
  var apiUrl, book, card, credit, editUser, exam, hnust, judge, lastUser, login, navbar, schedule, score, scoreClass, sortBy, tuition, user;
  ...
  scoreClass = function($scope, $location, getJsonpData) {
